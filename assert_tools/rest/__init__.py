...
def as_http_response(response, content=None):
    """
    convert request.Response object to httplib2 'Response'
    :param response:
        httplib2 'Response' object or request Response object

    :param content:
        content, required for httplib2 'Response'
    returns
...
def dict_as_http_response(data_dict):
    ...
    :param data_dict:
        dictionary to convert to httplib2 'Response' object
...
def make_api_call(url, method, kwargs):
    ...
    :param method:
        httplib2 ``method``:
         GET, POST, PUT, DELETE
    :param kwargs:
        dictionary of supported httplib2.Http() request
         body
         headers
         redirections
         connection_type
